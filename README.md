...
- Figma do projeto **Front-end** - https://www.figma.com/file/EN1zFtk4eY3Jgmpgi9YaMG/DSMeta1?node-id=0%3A1
...
- **H2** (Gerenciador de banco de dados) via **navegador**: http://localhost:8080/h2-console/
